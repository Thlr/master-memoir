...
SWF\footnote{https://www.cs.huji.ac.il/labs/parallel/workload/swf.html} format,
...
manager OAR \cite{oar}), and because it is convenient for us to test our
approach with HPC workloads.  However, even though Kubernetes does have means
to handle such workloads like batch schedulers \cite{kube-batch} and a special
type of
...
bypassed \cite{mercier:tel-02284996}. Still, containers are becoming more and more integrated in modern infrastructures.
